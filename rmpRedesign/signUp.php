            ...
            <div class="mb-md-3 mt-md-3">
              ...
              <form action=" " method="POST">
                ...
                <div class="form-white mb-4">
                  ...
                  <input type="email" class="whiteInput form-control form-control-lg" id="floatingInput" name="email"
                    required>
                </div>
                ...
                <div class="form-white mb-4">
                  ...
                  <input type="password" class="whiteInput form-control form-control-lg" id="floatingInput" name="pass"
                    required>
                </div>
                ...
                <div class="form-white mb-4">
                  ...
                  <input type="password" class="whiteInput form-control form-control-lg" id="floatingInput"
                    name="re_pass" required>
                </div>

                <!--continue button-->
                <button class="fakeBtnBlue proxima text-decoration-none btn-lg px-5 mb-3" type="submit" name="regsubmit"
